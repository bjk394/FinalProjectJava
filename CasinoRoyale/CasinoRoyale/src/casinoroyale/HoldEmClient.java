 ...
 * @author Steve
 */
public class HoldEmClient extends javax.swing.JFrame {
    ...
    public HoldEmClient(String nme, String ip, int prt) {
    ...
    void updateWinner(String[] pack) {
        ...
        for (int i = 1; i < 9; i++) { // changed to 13 from 14
            ...
            if (i < 6) {
                ...
                jlbls[i + 7].setIcon(rivercard);                // changed river.elementAt(i-1)
            }
        }
    }
...
//                           turn = Integer.parseInt(bs[0]);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HoldEmClient.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                //new HoldEmClient().setVisible(true);
            }
        });
    }
