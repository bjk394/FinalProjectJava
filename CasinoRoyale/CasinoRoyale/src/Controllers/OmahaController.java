...
public class OmahaController extends iGameController{
    public void dealCards() {
        int dealToPlayer;
        int randomCard;

        reset();    // reset game things

        //               *****Rig the hands for testing*****
//        this.pokerGame.getPlayers().elementAt(3).addCard(43);
//        this.pokerGame.getPlayers().elementAt(3).addCard(37);
//        this.pokerGame.getPlayers().elementAt(3).addCard(11);
//        this.pokerGame.getPlayers().elementAt(3).addCard(6);
//
//        this.pokerGame.getPlayers().elementAt(1).addCard(33);
//        this.pokerGame.getPlayers().elementAt(1).addCard(10);
//        this.pokerGame.getPlayers().elementAt(1).addCard(45);
//        this.pokerGame.getPlayers().elementAt(1).addCard(29);
//
//        this.pokerGame.getPlayers().elementAt(2).addCard(31);
//        this.pokerGame.getPlayers().elementAt(2).addCard(23);
//        this.pokerGame.getPlayers().elementAt(2).addCard(5);
//        this.pokerGame.getPlayers().elementAt(2).addCard(25);
//
//        this.pokerGame.getPlayers().elementAt(0).addCard(53);
//        this.pokerGame.getPlayers().elementAt(0).addCard(53);
//        this.pokerGame.getPlayers().elementAt(0).addCard(53);
//        this.pokerGame.getPlayers().elementAt(0).addCard(53);
//
//        this.pokerGame.getTable().addCardToRiver(8);
//        this.pokerGame.getTable().addCardToRiver(24);
//        this.pokerGame.getTable().addCardToRiver(7);
//        this.pokerGame.getTable().addCardToRiver(21);
//        this.pokerGame.getTable().addCardToRiver(20);

        for (int i = 0; i < this.pokerGame.getPlayers().size() * 4; i++) {  //deal 2 cards to each player
            randomCard = (int) (Math.random() * 52);
            while (pokerGame.getTable().deckContainsCard(randomCard) == false) {  //keep doing this until you get unused card
                randomCard = (int) (Math.random() * 52);
            }
            dealToPlayer = i % this.pokerGame.getPlayers().size();    //alternate players to deal to
            if (this.pokerGame.getPlayers().elementAt(dealToPlayer).getIsPlaying()) { //deal to them if they are still playing
                this.pokerGame.getPlayers().elementAt(dealToPlayer).addCard(randomCard);
                this.pokerGame.getTable().removeCard(randomCard);   //remove from free cards
            } else {
                this.pokerGame.getPlayers().elementAt(dealToPlayer).addCard(53);    //add 53 if they arent playing
            }
        }
        ...
        for (int i = 0; i < 5; i++) {
            ...
            this.pokerGame.getTable().addCardToRiver(randomCard);   //add card to river
            this.pokerGame.getTable().removeCard(randomCard);   //remove from free cards
        }
    }

    public void setGame(Game game) {
        this.pokerGame = game;  //set the game
    }
    ...
    private void nextPlayer() {
        ...
        if (this.pokerGame.getCurrentPlayer().getAllIn()) {
            this.pokerGame.incrementSuccessfulBets();
            this.checkForEndOfRound();
        }
    }
    ...
    private void checkForEndOfRound() {
        if (this.pokerGame.getSuccessfulBets() == this.pokerGame.playersStillIn()
            ...
            if (this.pokerGame.getPlayersAllIn() == this.pokerGame.playersStillIn()) {
                this.pokerGame.setRound(4);
            }

            if (this.pokerGame.getRound() == 4 || this.pokerGame.playersStillIn() == 1) { //if its the 4th round or there is only 1 player left
