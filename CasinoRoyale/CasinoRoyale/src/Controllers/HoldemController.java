...
public class HoldemController extends iGameController {
...
//        this.pokerGame.getPlayers().elementAt(0).addCard(49);
//        this.pokerGame.getPlayers().elementAt(0).addCard(2);
//
//        this.pokerGame.getPlayers().elementAt(1).addCard(10);
//        this.pokerGame.getPlayers().elementAt(1).addCard(9);
//
//        this.pokerGame.getPlayers().elementAt(2).addCard(53);
//        this.pokerGame.getPlayers().elementAt(2).addCard(53);
//
//        this.pokerGame.getPlayers().elementAt(3).addCard(53);
//        this.pokerGame.getPlayers().elementAt(3).addCard(53);
//
//        this.pokerGame.getTable().addCardToRiver(15);
//        this.pokerGame.getTable().addCardToRiver(36);
//        this.pokerGame.getTable().addCardToRiver(23);
//        this.pokerGame.getTable().addCardToRiver(4);
//        this.pokerGame.getTable().addCardToRiver(16);

        for (int i = 0; i < this.pokerGame.getPlayers().size() * 2; i++) {  //deal 2 cards to each player
