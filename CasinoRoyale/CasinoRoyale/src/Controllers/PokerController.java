...
public class PokerController extends iGameController {
    ...
    private void checkForEndOfRound() {
        if (this.pokerGame.getSuccessfulBets() == this.pokerGame.playersStillIn()
            ...
            if (this.pokerGame.getRound() == 3 || this.pokerGame.playersStillIn() == 1) { //if its the 4th round or there is only 1 player left
